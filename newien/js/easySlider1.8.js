    ...
    $.fn.easySlider = function (options) {
        ...
        return this.each(function () {
                ...
                if (options.numeric) {
                    for (var i = 0; i < s; i++) {
                        $(document.createElement("li"))
						    ...
						    .html('<a  class="png" rel=' + i + ' href=\"javascript:void(0);\">' + (i + 1) + '</a>')
            ...
            function setCurrent(i) {
                i = parseInt(i) + 1;
                $("#" + options.numericId).removeClass("scurrent");
                $("#" + options.numericId + i).addClass("scurrent");
            };
            ...
            function animate(dir, clicked) {
                if (clickable || !clicked) {
					...
					if(continueAction) {
						...
						$(">li", "#" + options.numericId).removeClass("scurrent");
